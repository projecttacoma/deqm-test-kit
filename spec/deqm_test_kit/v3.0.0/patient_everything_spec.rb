...
RSpec.describe DEQMTestKit::PatientEverything do
  ...
  describe 'Patient/<id>/$everything successful test' do
    ...
    single_patient_bundle = JSON.parse(File.read('./lib/fixtures/singlePatientBundle.json'))
    single_patient_response = File.read('./spec/fixtures/singlePatientResponse.json')
  ...
  describe 'Patient/$everything successful test' do
    ...
    multiple_patient_bundle = JSON.parse(File.read('./lib/fixtures/multiplePatientBundle.json'))
    multiple_patient_response = File.read('./spec/fixtures/multiplePatientResponse.json')
